...
class Blockchain:
    ...
    def from_json(chain_json):
        ...
        The result will contain a chian list of Block instances
        """
    ...
    def is_valid_chain(chain):
        ...
        Enfore the following rules for the blockchain:
    ...
    def is_valid_transaction_chain(chain):
        """
        Enforce the rules of a chain of blocks of transactions.
